...
public class ListaArray {
	//
	// CONSTANTES - Sempre definidas com todas as letras maiúsculas. Ao invés de
	// usar uma literal
	 ...
	 * privado, pois só deve ser visível internamente à classe ListaArray.
	 */
	private void verificarNecessidadeDeCrescimento() {
		...
		// Se o tamanho é igual ao número de elementos, é porque o arrayInterno está
		// cheio
		...
		if (tamanho == this.numElementos) {
			...
			// O novo array passa a ser o arrayInterno (o antigo será eliminado pelo garbage
			// collection)
	...
	public boolean adicionar(Object elemento) {
		...
		// Colocando a referência para o elemento na primeira posição livre do
		// arrayInterno
	...
	public boolean adicionar(Object elemento, int posicao) {
		...
		// Deslocando os elementos para abrir espaço para o elemento no array na posição
		// indicada
	 ...
	 * @return posição onde está o elemento ou NAO_ESTA_PRESENTE se não for
	 *         encontrado
	 */
	...
	/**
	 * Remove o elemento da posição indicada. Precisará agrupar os elementos para
	 * não deixar null ('buraco') no arrayInterno
	 * 
	 * @param posicao
	 * @return
	 */
